...
![](https://xilankong.github.io/resource/start.png)
...
按住CTRL键，从一个对象(比如一个按钮,一个表视图单元格,或选项卡视图项), 点击拖拽出一条线连接到目标控制器范围内松开鼠标。

![](https://xilankong.github.io/resource/SB_H_segue_add_drag.png)

在弹出弹窗中 选择Manual Segue中的选项即可连接成功, 得到如下一条蓝色线。
