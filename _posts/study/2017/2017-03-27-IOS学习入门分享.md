...
我们创建一个简单的demo，demo包括几个页面、页面直接的跳转。
...
起始标签 （1、表示起始标签，2、只有使用了系统导航条才会有的 rootViewController Relationship 链接）

![](https://xilankong.github.io/resource/storyboard_segue.png)

第三步、再添加一个普通控制器场景B，并从A拉出一条转场线链接到B场景

页面间的转场

![](https://xilankong.github.io/resource/segue.png)
