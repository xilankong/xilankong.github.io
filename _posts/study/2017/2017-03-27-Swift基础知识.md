...
![img](https://segmentfault.com/img/remote/1460000009728230?w=1240&h=394)
...
![img](https://segmentfault.com/img/remote/1460000009728231?w=1240&h=267)
...
```
默认编译器会检查返回参数是否被使用，产生警告  这个属性用来忽略警告
```
...
Declaration of 'Target_TrainCenterModuleAction' must be imported from module 'TrainCenterModule.Swift' before it is required