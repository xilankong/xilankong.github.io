...
查找对应的signing_identity   security 
...
dependency 库 pod lib lint 的时候异常，按理来说，已经通过dependency的方式引入，说明已经是ok的了，为什么还会异常？
...
UITableViewCell 不响应点击事件

到了IOS 11 一定要注意刷新控件的使用,手势操作谨慎使用