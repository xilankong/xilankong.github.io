...
分布式hash：
比如我1000个桶的分配，我可以hash对应的我查询的key，然后去对应的桶查具体的value么

一致性hash：
当我的1000个桶分配的时候中间断了一个怎么办，就得全部重新来过，而一致性hash把1000个桶处理为相当于一个环形链表，当出现问题的时候可以不需要重新来过
