...
Core Graphics、Core Animation、Core Image、OpenGL/Metal

Core Animation
  - 渲染、构建和实现动画
  - CALayer 是显示的基础：存储 bitmap。设备刷新时，CALayer读取生成好的bitmap展示
  - Commit Transaction 递交Render Server
  - Render Server图片解码 展示
